...
node {
   ...
   { 
        stage('Authorize hub org and set default CI scratch org') 
        {
			...
			rc = sh returnStatus: true, script: "'sfdx force:auth:jwt:grant --clientid 3MVG9YDQS5WtC11rw.7q_jJ8RGZyjjHwBON9IJd3A0LEvuY1OJwBrgOR8_qCMeDeISp_3gyScR36gBMkKKJAm --username demodevhubaccount123@cognizant.com --jwtkeyfile '${jwt_key_file}' --setdefaultdevhubusername --instanceurl https://login.aaalesforce.com"
